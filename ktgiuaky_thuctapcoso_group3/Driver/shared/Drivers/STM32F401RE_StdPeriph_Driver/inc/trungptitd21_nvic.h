...
typedef struct
{
	...
	uint8_t NVIC_IRQChannelSubPriority;         /*!< Specifies the sub-priority level for the IRQ channel specified
...
#define NVIC_LP_SLEEPONEXIT		(((LP) == NVIC_LP_SEVONPEND) || ((LP) == NVIC_LP_SLEEPDEEP) || ((LP) == NVIC_LP_SLEEPONEXIT))
